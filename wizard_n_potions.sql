CREATE DATABASE  IF NOT EXISTS `wizards_n_potions` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `potion` (
  ...
  KEY `potion_category_FK` (`category_id`),
  CONSTRAINT `potion_category_FK` FOREIGN KEY (`category_id`) REFERENCES `category` (`category_id`)
...
--
-- Table structure for table `potion_has_ingredients`
--

DROP TABLE IF EXISTS `potion_has_ingredients`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `potion_has_ingredients` (
  `potion_id` int NOT NULL,
  `ingredient_id` int NOT NULL,
  `quantity` int NOT NULL,
  PRIMARY KEY (`potion_id`,`ingredient_id`),
  KEY `potion_ingredient_ingredient_FK` (`ingredient_id`),
  CONSTRAINT `potion_ingredient_ingredient_FK` FOREIGN KEY (`ingredient_id`) REFERENCES `ingredient` (`ingredient_id`),
  CONSTRAINT `potion_ingredient_potion0_FK` FOREIGN KEY (`potion_id`) REFERENCES `potion` (`potion_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `potion_has_ingredients`
--

LOCK TABLES `potion_has_ingredients` WRITE;
/*!40000 ALTER TABLE `potion_has_ingredients` DISABLE KEYS */;
INSERT INTO `potion_has_ingredients` VALUES (1,5,8),(2,17,4),(2,18,7),(2,30,5),(3,24,10),(4,1,3),(4,2,4),(4,22,1),(5,7,9),(5,30,5),(6,10,9),(7,15,7),(7,21,8),(8,3,1),(8,21,6),(8,24,10),(9,3,1),(9,11,4),(9,18,2),(9,19,9),(10,12,7),(10,20,2),(10,32,3),(11,9,6),(11,22,8),(11,25,9),(12,10,7),(12,29,3),(13,11,10),(13,17,1),(14,27,6),(15,3,6),(15,10,8),(15,28,6),(16,9,1),(17,1,1),(17,18,8),(18,28,2),(19,12,9),(19,19,7),(19,30,10),(20,8,1),(20,13,5),(20,19,4),(20,27,1);
/*!40000 ALTER TABLE `potion_has_ingredients` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-01-08 19:01:34
